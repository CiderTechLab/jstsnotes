 ...
 *   なる。
 */
function excessPropertyCheck(): void {
 ...
 */
function optionalProperty(): void {
	console.log('---オプショナルプロパティ---');
	type person = {
		name: string;
		age?: number; // ageプロパティはオプショナル
	};
...
function taggedUnion(): void {
	...
	// MEMO: タグ付きユニオン型
	// - player型はpitcher型とbatter型のどちらかであることを表す。
 ...
 */
function intersectionObject(): void {
