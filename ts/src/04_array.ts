...
// string型の配列を返す関数型の配列
let stringPlayers: (() => string[])[];

/**
 * ユニオン型の配列
 */
console.log('---ユニオン型の配列---');
let unionPlayers: (string | number)[];
...
let arraySpread1: number[] = [1, 2, 3];
let arraySpread2: number[] = [4, 5, 6];
let arraySpread3: number[] = [...arraySpread1, ...arraySpread2];
